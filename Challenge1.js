...
// Your job is to delete the digits of a given number that, within their name written in English,
// contain a given vowel.
...
//   the new integer obtained after the elimination of banned digits (as
//   a natural number without leading zeros).
